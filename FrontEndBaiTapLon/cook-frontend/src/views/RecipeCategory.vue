...
export default {
    ...
    methods: {
        async retrieveRecipeGenre() {
            try {
                this.arrRecipeGenre = await CategoryService.getAllRecipe();
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumbs-area">
                        <h1>Danh Mục Công Thức Nấu Ăn</h1>
                        <ul>
                            <li>
                                <a href="/">Home</a>
                            </li>
                            <li>Danh Mục Công Thức</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div v-for="draw in this.arrRecipeGenre" class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="category-box-layout1">
                        ...
                        <div class="item-content">
                            ...
                            <span class="sub-title"> {{ draw.quanRecipe }} Công Thức</span>
                        </div>
                    </div>
                </div>
            </div>
